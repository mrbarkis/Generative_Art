...
path_c = red_c + [100]  # mix_colors(blue_c, gray, 0.01) + [100]
...
def loadData():
    ...
    # path = pickle.load(
    #     open(os.path.join("..", "data", "79163km_8166xs_123seed_10walks_10kTs.p"), "rb")
    # )
...
def draw():
    ...
    xs, ys = (scale_and_move(xs, 117, 375), scale_and_move(ys, -206.5, 894))
